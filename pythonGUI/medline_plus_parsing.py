...
class MedlinePlusScraper:
    ...
    def extract_side_effects(self, url: str) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"  ✓ Extracted {total_items} side effect entries from" +
                  "{side_effects_data['metadata']['sections_found']} sections")
...
def extract_medline_data(drug_name):
    if not drug_name:
